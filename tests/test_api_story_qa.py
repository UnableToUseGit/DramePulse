...
class StoryQaApiTest(unittest.TestCase):
    ...
    def test_lightrag_uses_series_specific_working_dirs_and_cache(self) -> None:
        ...
        self.assertEqual(Path(rag_instances[0].kwargs["working_dir"]), drama_a_dir.resolve())
        self.assertEqual(Path(rag_instances[1].kwargs["working_dir"]), drama_b_dir.resolve())
