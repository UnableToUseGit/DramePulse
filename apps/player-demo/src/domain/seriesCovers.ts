...
const SERIES_COVERS: Record<string, ImageSourcePropType> = {
  ...
  jialijiawai: require("../../assets/covers/jiali_jiawai.jpg"),
  jiali_jiawai: require("../../assets/covers/jiali_jiawai.jpg"),
  naniandonzhi: require("../../assets/covers/nanian_dongzhi.webp"),
  ...
  tianxiadiyiwanku: require("../../assets/covers/tianxia_diyi_wanku.webp"),
  ...
  yunmiao1: require("../../assets/covers/yunmiao_1.webp"),
