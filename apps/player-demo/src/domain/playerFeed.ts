...
const HOME_BOTTOM_DOCK_HEIGHT_PX = 74;
const SERIES_BOTTOM_DOCK_HEIGHT_PX = 96;
const CONTROLS_ABOVE_DOCK_OFFSET_PX = -2;
const META_ABOVE_DOCK_OFFSET_PX = 44;
const ACTION_RAIL_ABOVE_DOCK_OFFSET_PX = 50;
